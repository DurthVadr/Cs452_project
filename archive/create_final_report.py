...
# Create output directories for final report
...
if not os.path.exists('html_reports/images'):
    os.makedirs('html_reports/images')
...
plt.savefig('html_reports/images/accuracy_by_elo_diff.png')
...
plt.savefig('html_reports/images/accuracy_by_upset.png')
...
plt.savefig('html_reports/images/four_factors_win_pct.png')
...
plt.savefig('html_reports/images/top_teams_win_pct.png')
...
plt.savefig('html_reports/images/top_upset_teams.png')
...
plt.savefig('html_reports/images/team_clusters.png')
...
plt.savefig('html_reports/images/elo_parameter_search.png')
...
with open('final_report/nba_prediction_report.md', 'w') as f:
    ...
    # Create a version for the final_report directory
...
# Create a separate Markdown file for html_reports
print("Creating Markdown file for html_reports...")
...
<body>
    ...
    print("HTML reports created successfully in final_report/ and html_reports/ directories!")
except ImportError:
